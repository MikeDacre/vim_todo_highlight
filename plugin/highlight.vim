...
" Highlight NOTE
autocmd InsertEnter * match NoteComment /[ ]NOTE[ :]\c/
autocmd BufRead,InsertLeave * match NoteComment /[ ]NOTE[ :]\c/
autocmd InsertEnter * match LineNoteComment /^NOTE[ :]\c/
autocmd BufRead,InsertLeave * match LineNoteComment /^NOTE[ :]\c/
